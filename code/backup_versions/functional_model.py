...
alpha = 5* 10**-3 # 1.25*10**-3# 10**-3 #1.5*10**-3#2*10**-3# 1*10**-3# 1.25*10**-3 # rate of action in nest
beta = 1 # 1/2#2/3 # 1/4 #3/4# 1.2 # 2/3# 1/5 # rate of action in arena
gamma = 0#10**-5 # 5*10**-6 # spontaneous activation
p = 0
Theta = 10**-15# 10**-15 # baseline loss of activity (threshold 1)
theta = 0 # threshold of activity (threshold 2)
Interactions = 1#1 # integer, number of max interactions in a node
...
class Ant(Agent):
	...
	def __init__(self, unique_id, model):
		...
		self.Si = 0
		# self.g = np.random.uniform(0.5, 1.0)
		self.g = np.random.uniform(0.05, 0.95)
