...
Jij = {'0-0': 0.1, '0-1': 10**5, '0-2': 10**10, '0-3': 10**10,
		'1-0': 0.05, '1-1': 0.75, '1-2': 10**5, '1-3': 10**10,
	   '2-0': 0.05, '2-1': 0.5, '2-2': 0.75, '2-3': 10**5,
	   '3-0': 0.05, '3-1': 0.5, '3-2': 0.5, '3-3': 0.75}
...
class Ant(Agent):
	...
	def __init__(self, unique_id, model):
		...
		self.g = np.random.normal(0.55, 0.15)
		# self.theta = np.random.uniform(10**-1, 10**-30)
		self.history = 0
