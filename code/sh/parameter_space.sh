...
do
    ...
    do
    python3 ~/research/AutomatAnts/code/Run.py --directory ~/research/AutomatAnts/results/parameter_space/ --filename alpha=${alpha/,/.}_beta=${beta/,/.} -n 1 -p alpha=${alpha/,/.},beta=${beta/,/.}
