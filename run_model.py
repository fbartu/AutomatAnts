...
np.savetxt("Results/"+params.file_name+"_state.dat",DataOut_states)

#Save food data
DataOut_food = np.column_stack((time1,f_nest,f_site_1,f_site_2))
np.savetxt("Results/"+params.file_name+"_food.dat",DataOut_food)

#Save Connectivity
DataOut_k = np.column_stack((time2,k_count,i_count))
np.savetxt("Results/"+params.file_name+"_k.dat",DataOut_k)

#Save Tag
DataOut_tag = np.column_stack((time1,tag_null,tag_naif,tag_informed))
np.savetxt("Results/"+params.file_name+"_tag.dat",DataOut_tag)
